...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-@)wqf7vg!19^vwo8eko55v98@v%!u6u%h+^3l%fq1iai_6z%&_")
...
DATABASES = {
    'default': {
        ...
        "NAME": os.environ.get("SQL_DATABASE", "throod_db"),
        "USER": os.environ.get("SQL_USER", "postgres"),
        "PASSWORD": os.environ.get("SQL_PASSWORD", "375079"),
